...
public function init()
	...
	function indexAction(){
		try{
	    	...
	    	$columns=array("TRANSFER_NUM","REQUEST_DATE","DATE_IN","REQUET_TO_FROM","REQUET_TO_BRANCH","ORDER_STATUS","PEDDING","USER","STATUS");
	    	
	    	$link=array(
	    		'module'=>'product','controller'=>'apprequest','action'=>'add',
	    	);

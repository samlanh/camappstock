...
class Sales_Form_FrmStock extends Zend_Form
{
	...
	public function showSaleAgentForm($data=null, $stockID=null) {
    	...
    	$addressElement->setAttribs(array(
    	...
    	$jobTitleElement->setAttribs(array(
		...
		$descriptionElement->setAttribs(array(
				'placeholder'=>'Descrtion Here...',"class"=>"form-control","rows"=>3));
    	...
    	$mainStockElement->setAttribs(array('OnChange'=>'getSaleCode()',
    	...
    	$pob->setAttribs(array(
    			'placeholder'=>'Enter Place of Birdth',
    			'dojoType'=>"dijit.form.TextBox",
    			'class'=>'fullside',
    			));
    	$this->addElement($pob);
    	...
    	$bank_acc->setAttribs(array('placeholder'=>'Enter Bank Account',
    			'dojoType'=>"dijit.form.TextBox",
				'class'=>'fullside',	));
    	$this->addElement($bank_acc);
    	
    	$refer_name = new Zend_Form_Element_Text("refer_name");
    	$refer_name->setAttribs(array('placeholder'=>'Enter Reference Name',
    			'dojoType'=>"dijit.form.TextBox",
				'class'=>'fullside',
    			));
    	...
    	$refer_phone->setAttribs(array('placeholder'=>'Enter Reference Phone',
    			'dojoType'=>"dijit.form.TextBox",
				'class'=>'fullside',	
    			));
    	...
    	$refer_addres->setAttribs(array('placeholder'=>'Enter Reference Address',
    			'dojoType'=>"dijit.form.TextBox",
				'class'=>'fullside'
    			,"style"=>"height:40px"));
    	...
    	$satrt_working_date->setAttribs(array(
    			'placeholder'=>'Enter Bank Account',
    			'dojoType'=>"dijit.form.DateTextBox",
    			'class'=>'fullside',
    			'constraints'=>"{datePattern:'dd/MM/yyyy'}",
    			));
    	$satrt_working_date->setValue($date->get('Y-m-d'));
